...
# model dump is build in the funtion inside the pyton that convert your pydantic model to dictionar

temp=patient1.model_dump()
# in case you wanna export some of the specific things from the class than 
# templ=patient.model_dump(include={'name','age'})
